...
# Common system rules shared across chat and voice modes
BASE_SYSTEM_RULES = (
    ...
    "や Google カレンダー・Gmail ツールが利用可能な場合、必要に応じて積極的に呼び出して事実に基づいた回答を行ってください。\n"
...
DEFAULT_CHAT_SYSTEM_PROMPT = (
    ...
    "- ユーザーのLPデザインの提案, API設計, 週次レポート作成, 競合分析などをサポートします。"
)
