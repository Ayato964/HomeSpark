        ...
        <div style={{
          ...
          <div>
            ...
            <ul style={{ margin: 0, paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '6px', fontSize: '13px', color: 'var(--text2)', lineHeight: 1.6 }}>
              ...
              <li><strong>💬 デスクトップ最前面・常駐字幕オーバーレイ（HUD Overlay ピル）</strong>: トレイ格納中や別作業（ブラウザ、Excel、ゲーム等）をしていても、ジェニーと話すと画面最下部の中央に半透明の字幕ピルがスッと浮き上がり、リアルタイムに会話内容を表示。クリック透過で作業を一切邪魔せず、発話終了後に自動でフェードアウトします。</li>
